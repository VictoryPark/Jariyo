            ...
            <form action="<c:url value="/booking/insert.do"/>" method="post">
                ...
                *이용 시간 : <input type="text" name="starttime" value="달력에서 표시한 시작시간"disabled/>
                ...
                예약자 이메일주소 : <input type="email" name="email" placeholder="예약 확인을 받아볼 메일 주소" /><br>
                  메일 발송 여부 <input id="send1" type="radio" name="emailsend" value="y" checked/>
                  			  <label for="send1">발송원함</label>
                              <input id="send2" type="radio" name="emailsend" value="n"> 
                              <label for="send2">발송원하지 않음</label>
                </p>
                <p>
                *예약자 전화번호 : <input type="tel" name="tel" 
                				placeholder="연락가능한 전화번호를 -을 빼고 작성" required/>
                </p>
                <p>
