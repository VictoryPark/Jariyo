	...
	<main>
	    ...
	    <center>
		  ...
		  <p> 
			    ...
			    <table id="msglist">
				    ...
				    <tr>
				    	...
				    	<td><%= kind %></td>
				    	<td><%= m.getToName() %></td>
				    	<td><a href='sedetailmsg.j?no=<%=m.getMsgNo() %>'><%=m.getTitle() %></a></td>
				    	<td><%= m.getRegDate() %></td>
				   	</tr>
				   	<%
				    }
		 ...
		 <p> 
		    ...
		    <a href=#5>5</a>   
		    <a href=#1 >></a>
		    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="writeform.j">쪽지쓰기</a>&nbsp&nbsp&nbsp<a href="deletemsglist.do"><button>삭제하기</button></a>
		    </p>  
