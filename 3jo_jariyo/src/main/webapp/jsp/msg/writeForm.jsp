			...
			<form action="writemsg.do" method="post">
				...
				<tr>
					...
					<th><select name="kind">
							...
							<option value="1">용병모집</option>
							<option value="2">용병신청</option>
							<option value="3">팀매칭</option>
					</select></th>
				</tr>
				<tr>
					<th>제목</th>
					<th><textarea class="title" name="title" rows=1 cols=60></textarea>
					</th>
				</tr>
				<tr>
					<th>내용</th>
					<th><textarea class="w100" name="content" rows=20 cols=60></textarea>
					</th>
				</tr>
		</table>
		<p></p>
