...
<body>
	...
	<section>
		...
		<span>
		    ...
		    <button>검색</button>
		    <button><a href="<c:url value="/mangather/writeForm.do"/>">글쓰기</a></button>
		 </span>
		 </div>
		 <table>
		    	<tr>
		...
		<c:forEach var="b" items="${list}">
		    	<tr>
					...
					<td><a href="<c:url value='/mangather/detail.do?boardNo=${b.boardNo}'/>"><c:out value="${b.title}"/></a></td>
					<td><c:out value="${b.writerId}"/></td>
